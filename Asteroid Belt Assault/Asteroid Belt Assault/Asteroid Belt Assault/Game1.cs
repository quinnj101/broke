...
namespace Asteroid_Belt_Assault
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            q = Content.Load<Texture2D>(@"Textures\Planets");
            ...
            sun=new Sprite(new Vector2(10, 200), q, new Rectangle(2 * 59, 3 * 59, 59, 59), new Vector2(0, 0));
            earth=new Sprite(new Vector2(280, 170), q, new Rectangle(3 * 59, 3 * 59, 59, 59), new Vector2(0, 0));
            mercury = new Sprite(new Vector2(150, 200), q, new Rectangle(1 * 59, 3 * 59, 59, 59), new Vector2(0, 0));
            neptune=new Sprite(new Vector2(700, 100), q, new Rectangle(0 * 59, 3 * 59, 59, 59), new Vector2(0, 0));
            mars=new Sprite(new Vector2(500, 220), q, new Rectangle(1 * 59, 2 * 59, 59, 59), new Vector2(0, 0));
            ...
            Planets ThePlanet = new Planets(Content.Load<Texture2D>(@"Textures\hp"), Content.Load<Texture2D>(@"Textures\vial"));
        ...
        public string getplanet()
        {
            ...
            if (ThePlanet.kills != 0 )return "MARS";
            else
            {
                return "no";
            }
